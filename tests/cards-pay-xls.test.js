...
test('★★ 「메일 없음」처럼 «글로 적어 둔 빈칸»을 값으로 넣지 않는다', () => {
  ...
  const grid = [
    ...
    ['1', '천성가축약품', '송향숙 실장', '010-9799-3249', '메일 없음', 'x', '-', '없음'],
  ];
...
const GRID = [
  ['연번', '사업장명', '담당자 성명', '담당자연락처', '이메일주소', '세무대리인명', '세무담당자연락처', '세무담당자 이메일주소'],
  ['1', '(주)위드유', '김영식 대표', '010-5465-2767', 'a@x.com', '', '', ''],
  ['', '', '김안아 과장', '010-2589-2480', 'b@x.com', '', '', ''],
  ['2', '늘봄반찬(모종점)', '정수연 담당자', '010-6383-7727', 'c@x.com', '세무법인 온', '041-547-2100', 't@x.com'],
  ['3', '늘봄반찬(배방점)', '', '', '', '', '', ''],
];
...
test('★ 기업정보함 «가져오기»가 쓰는 줄 모양으로 돌려준다', () => {
  ...
  assert.equal(kim.mobile, '010-5465-2767', '★ 휴대폰이 mobile 칸에 안 들어갔습니다');
