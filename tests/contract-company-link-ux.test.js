'use strict';
/* 계약 입력의 「업체 연결 확인」이 «혼내지 않는다» (대표 제보 2026-09-07)
 *
 ...
 *   정확한 사업자번호 하나만 자동 연결하고, 이름 후보는 «누르면 끝나는 단추»를 둔다.
 */
const fs = require('fs');
...
const 대목 = SRC.slice(SRC.indexOf("'업체 연결 확인'") - 600,
                      SRC.indexOf("'업체 연결 확인'") + 2600);
...
test('★★ 이름만으로 «저절로» 채우지 않는다 — 온톨로지 규칙이다', () => {
