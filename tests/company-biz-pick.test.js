/* 업체 수정 — 「명함첩에서 사업자등록증 찾기」 + 단추를 제목 줄로
   (2026-08-10) 대표 지시: "사업자등록증 찾는 것도 명함첩에서 사업자 찾기도 넣어달라.
...
t('없는 칸을 알린다', /명함첩에 사업자번호·업태·종목·주소·팩스·대표 이메일 없음/.test(c.msg), true);
...
t('★ 옛 자리(대표자 칸 아래)의 단추는 걷어냈다',
  /marginTop:'5px'[\s\S]{0,200}?'📇 명함첩에서 대표자 찾기'/.test(src), false);
