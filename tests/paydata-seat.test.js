...
function loadApp(appState) {
  ...
  new vm.Script([
    ...
    cut('folderOptionsHtml'), cut('monthShift'), cut('monthCount'), cut('monthAhead'), cut('monthStripHtml'), cut('sideCtx'), cut('guessTag'), cut('siteState'), cut('sideListModel'), cut('coArrivedAt'), cut('screenDrawer'),
