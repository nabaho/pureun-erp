...
ALIASES = {
    "참살이": "참살이 사내", "캔탑스": "참살이 사내",
    "플러스": "플러스 공동", "케이원": "플러스 공동",
    "이비공동": "이비공동", "EB 공동": "이비공동", "이벌브": "이비공동",
    "가치를만들": "가치를만들어가는사람들", "가치를 만들": "가치를만들어가는사람들", "수영로지콘": "가치를만들어가는사람들",
    "안전공사": "안전공사공동", "건설안전공사": "안전공사공동",
    "청신": "청신공동", "청원건설": "청신공동",
    "배경": "배경공동", "디와이": "디와이사내", "동경이엔지": "디와이사내",
    "일원공동": "일원공동", "나래산업": "나래산업사내", "현재기업": "현재기업사내",
    "수공건설": "수공건설사내", "다움": "다움사내",
    "더행복한": "충남 1호",
}
for n in range(1, 13):
