...
NAME_BLOCK = {
    ...
    # 공휴일·달력 표기(근태표에 흔함 — 이름 아님)
    "설날", "추석", "신정", "개천절", "광복절", "삼일절", "어린이날", "한글날",
    "현충일", "성탄절", "석탄일", "대체휴일", "임시공휴", "선거일", "근로자의날",
    "연차휴가", "경조휴가", "병가", "공가", "무급휴가",
    # 행정·서식 용어
    "국적", "성별", "입사자", "퇴사자", "담당", "당행송금", "타행송금", "비고",
    "구분", "번호", "합산", "총액", "계좌", "은행", "금액", "시간", "일수",
}
AUX_KEYS = {
