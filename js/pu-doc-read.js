...
(function (global) {
  ...
  var KINDS = { card: 1, bizreg: 1, sme: 1, payslip: 1, meeting: 1, contract: 1, chat: 1, timesheet: 1, cms: 1, form: 1, other: 1 };
  ...
  var READ_VERSION = 12;  // …/ 10 = 서식에 매출액·상시근로자수 등을 이름 붙은 키로 / 11 = 글자 있는 PDF 는 글자로 판독(그림 왕복 없음) / 12 = 통장·계좌(bankbook) 갈래 추가
