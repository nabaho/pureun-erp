...
(function (global) {
  ...
  var KINDS = { card: 1, bizreg: 1, sme: 1, payslip: 1, meeting: 1, contract: 1, chat: 1, timesheet: 1, cms: 1, bankbook: 1, idcard: 1, resident: 1, mandate: 1, consent: 1, form: 1, other: 1 };
  ...
  var READ_VERSION = 13;  // …/ 11 = 글자 있는 PDF 는 글자로 판독(그림 왕복 없음) / 12 = 통장·계좌(bankbook) 갈래 추가 / 13 = 통장·근로자서류 다섯이 KINDS 에 빠져 other 로 굳던 것을 고침 + 급여명세서 이름
