...
(function (global) {
  ...
  var KINDS = { card: 1, bizreg: 1, sme: 1, payslip: 1, meeting: 1, contract: 1, chat: 1, timesheet: 1, other: 1 };
  ...
  var READ_VERSION = 5;   // 1 = card·bizreg·sme·meeting·other / 2 = payslip / 3 = 한글 우선 / 4 = chat / 5 = timesheet(근태·휴무표)
