...
(function (global) {
  ...
  var READ_VERSION = 15;  // …/ 11 = 글자 있는 PDF 는 글자로 판독(그림 왕복 없음) / 12 = 통장·계좌(bankbook) 갈래 추가 / 13 = 통장·근로자서류 다섯이 KINDS 에 빠져 other 로 굳던 것을 고침 + 급여명세서 이름 / 14 = 근로계약서(wcontract) 갈래 / 15 = 근로계약서의 임금(사람이 확인해야 산다)
