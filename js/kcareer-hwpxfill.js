...
(function (root) {
  ...
  var FIELD_LABELS = [
    ...
    { re: /^(영문|영문성명|영문이름|성명영문|영문명)$/, key: 'nameEng' },
    ...
    { re: /^(사무실전화|직장전화|회사전화|사무실전화번호|근무처전화)$/, key: 'phoneWork' },
    { re: /^(팩스|팩스번호|fax)$/i, key: 'fax' },
    { re: /^(이메일|전자우편|e-?mail|메일주소)$/i, key: 'email' },
    { re: /^(주소|현주소|거주지|자택주소|주민등록주소|자택주소지)$/, key: 'addr' },
    { re: /^(회사주소|사무실주소|직장주소|근무지주소|근무처주소)$/, key: 'addrWork' },
