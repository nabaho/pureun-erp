...
/* ═══════════════════════════════════════════════════════════════════════
  ...
  /* ★ 「이름」은 «글 제목» 칸이다 (2026-08-31 실제 편집 화면을 보고 넣었다).
     목록 카드에 「권형하대표」로 붙어 보이는 것은 홈페이지가 «제목 + 직책1» 을
     붙여 찍기 때문이고, 제목 칸에는 이름만 들어 있다(「박성수」로 확인).
     그래서 제목에 이름을 써도 직책이 사라지지 않는다.
     ⚠ 카드에서 이름과 직책이 붙어 보이는 것은 «홈페이지 스킨» 쪽 일이다 —
       직책 값 앞에 공백을 넣어 벌리려 하지 말 것. 대조가 그 공백을 두고 흔들린다. */
  var MEMBER_FIELDS = [
    { key: '이름', label: '제목', name: 'title' },
